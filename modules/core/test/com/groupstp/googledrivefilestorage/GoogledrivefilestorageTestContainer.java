package com.groupstp.googledrivefilestorage;
...
public class GoogledrivefilestorageTestContainer extends TestContainer {

    public GoogledrivefilestorageTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/groupstp/googledrivefilestorage/app.properties",
    ...
    public static class Common extends GoogledrivefilestorageTestContainer {

        public static final GoogledrivefilestorageTestContainer.Common INSTANCE = new GoogledrivefilestorageTestContainer.Common();
